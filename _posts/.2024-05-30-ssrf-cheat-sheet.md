...
The following wrappers are expected within Java environments, and can be used to potentially exploit [LFI](https://hacksofdhruv.me/blog/lfi-cheat-sheet/) vulnerabilities. 
